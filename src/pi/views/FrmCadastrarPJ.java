...
public final class FrmCadastrarPJ extends javax.swing.JInternalFrame {
    ...
    public FrmCadastrarPJ() {
        ...
        setFornecedor((ArrayList) CadastrarFornecedor.getFornecedor());
    ...
    public void atualizarLinhaSelecionada() {
        this.getjTableFornecedor().getSelectionModel().setSelectionInterval(this.jTableLinhaSelecionada, this.jTableLinhaSelecionada);
        getjTableFornecedor().setSelectionBackground(Color.CYAN);
    }

    public void iniciarTabela() {
        model = new ModelJTable((ArrayList) getFornecedor());
        getjTableFornecedor().setModel(model);
    }
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(btnDeletePJ, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(btnInsertEmpresa, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(btnUpdateEmpresa, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)))))
...
//        this.getTxtID().setText(jTableFornecedor.getValueAt(linha_selecionada, 14).toString());
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if (!this.getTxtBuscar().getText().trim().equals("")) {
    ...
    private void btnInsertEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertEmpresaActionPerformed
        ...
        if (!this.getTxtRazaoS().getText().equals("") && !this.getTxtCnpj().getText().equals("") && !this.getTxtEmail().getText().equals("")) {
    ...
    private void btnUpdateEmpresaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateEmpresaActionPerformed
        ModelPessoaJuridica passagem = instanceControllerCadastrarFornecedor.passagem(
                ...
                this.getTxtComplemento().getText(),
                this.getTxtCep().getText());
        boolean update = instanceControllerCadastrarFornecedor.update(Integer.parseInt(getTxtID().getText()), passagem);
        if (update) {
            resetForm();
            /*// Visibilidade dos botões.*/
            this.getBtnUpdateEmpresa().setVisible(false);
    ...
    private void btnPrintAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintAllActionPerformed
        FrmConsultarFornecedor prod = new FrmConsultarFornecedor();
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        if (Integer.parseInt(getTxtID().getText()) >= 0) {
            ...
            ListaAuxiliar.add(pi.controller.CadastrarFornecedor.getFornecedor().get(Integer.parseInt(getTxtID().getText()))); // Passa o id do cadastro.
    ...
    public void setFornecedor(ArrayList fornecedor) {
