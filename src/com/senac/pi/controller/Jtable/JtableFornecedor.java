...
public class JtableFornecedor {
    ...
    private static com.senac.pi.views.FrmCadastrarPJ _viewFrm;
...
//        ((ModelJTable) this.getViewFrm().getjTableFornecedor().getModel()).DeleteRow(id);
     ...
     * GETTERS E SETTERS *
     */
    private com.senac.pi.views.FrmCadastrarPJ getViewFrm() {
        return _viewFrm;
    }

    private void setViewFrm(com.senac.pi.views.FrmCadastrarPJ ViewFrmFornecedor) {
