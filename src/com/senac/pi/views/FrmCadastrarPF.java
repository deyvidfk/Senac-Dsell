...
import com.senac.util.ValidaForm;

/**
 *
 * @author deyvid.souza
 */
public class FrmCadastrarPF extends javax.swing.JInternalFrame {
...
//        this.getBtnRegistroAnterior().setEnabled(false);
    ...
    private void btnInsertUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertUsuarioActionPerformed
        boolean creat = instanceControllerCadastrarUsuario.creat(this.getTxtNome().getText(), this.getTxtRg().getText(), this.getTxtCpf().getText(), this.getTxtTelefone().getText(), this.getTxtEmail().getText(), this.getTxtSite().getText(), this.getTxtCidade().getText(), this.getTxtEstado().getText(), this.getTxtPais().getText(), this.getTxtBairro().getText(), this.getTxtRua().getText(), this.getTxtNumero().getText(), this.getTxtComplemento().getText(), this.getTxtCep().getText());
        if (creat) {
            resetForm();
            instanceControllerJtable.updateJtable();
            /*// Visibilidade dos botões.*/
    ...
    public CadastrarUsuario getInstanceControllerCadastrarUsuario() {
        return instanceControllerCadastrarUsuario;
    }

    public void setInstanceControllerCadastrarUsuario(CadastrarUsuario instanceControllerCadastrarUsuario) {
        this.instanceControllerCadastrarUsuario = instanceControllerCadastrarUsuario;
    }
